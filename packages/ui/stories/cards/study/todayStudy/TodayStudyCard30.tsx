...
export const TodayStudyCard30: FC<Props> = (props: Props) => {
    const handleClick = () => {
    ...
    return (
        <StyledContainer onClick={handleClick}>
            ...
            />
            <StyledImage
                src="/cards/todayStudy/30.png"
                srcSet="/cards/todayStudy/30.png 1x, /cards/todayStudy/30@2x.png 2x"
            />
            <StyledTitleContainer>
                <StyledTitleTop>
                    <span>영어</span>
