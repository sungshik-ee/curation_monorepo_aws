...
export const TodayStudyCard60: (props: Props) => JSX.Element = (props: Props) => {
    const handleClick = () => {
        props.onClick({});
    };
    return (
        <StyledContainer onClick={handleClick}>
            ...
            />
            <StyledImage src="/cards/todayStudy/60.png" srcSet="/cards/todayStudy/60.png 1x, /cards/todayStudy/60@2x.png 2x"/>

            <StyledTitle>
                <span>초등국어<br/>교과서 읽기</span>
            </StyledTitle>
        </StyledContainer>
    );
};
