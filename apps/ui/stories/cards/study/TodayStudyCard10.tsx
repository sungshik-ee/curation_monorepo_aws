...
export const TodayStudyCard10: (props: Props) => JSX.Element = (props: Props) => {
    const handleClick = () => {
        props.onClick({});
    };
    return (
        <StyledContainer onClick={handleClick}>
            ...
            <StyledImage
                src="/cards/todayStudyBody10.png"
                srcSet="cards/todayStudyBody10.png 1x, cards/todayStudyBody10@2x.png 2x"
            />
        </StyledContainer>
    );
};
