...
const StyledRect1 = styled.rect`
    fill: rgba(188, 133, 75, 1);
`;
const StyledPath7 = styled.path`
    fill: rgba(211, 145, 73, 1);
`;
...
`;
export const TodayStudyCard60: FC<Props> = (props: Props) => {
    const handleClick = () => {
    ...
    return (
        <StyledContainer onClick={handleClick}>
            ...
            />
            <StyledImage
                src="/cards/todayStudy/60.png"
                srcSet="/cards/todayStudy/60.png 1x, /cards/todayStudy/60@2x.png 2x"
            />
...
TodayStudyCard60.defaultProps = {
    key: 'TODAY_STUDY_SCHOOL_K',
};
